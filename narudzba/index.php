	...
	$("#trazi").keyup(function(event){
		...
		//alert("idem tražiti");
			...
			$.ajax({
				type: "POST",
				url: "read.php",
				data: "datum=" + $("#trazi").val(),
				success: function(vratioServer){
					var rezultati=$.parseJSON(vratioServer);
					$("#podaci").html("");
					$.each(rezultati,function(key,narudzba){
						$("#podaci").append("<tr><td>" + narudzba.sifra + "</td><td>" + narudzba.datum + "</td><td>" + narudzba.gost + "</td>" + 
								"<td class=\"centar\"> <a title=\"Promijeni\" href=\"update.php?sifra=" + narudzba.sifra + "\"><img alt=\"update\" src=\"<?php echo $putanja;?>update.png\" /></a>" + 
								" || <a title=\"Obriši\" href=\"delete.php?sifra=" + narudzba.sifra + "\"><img alt=\"delete\" src=\"<?php echo $putanja;?>delete.png\" /></a></td></tr>");
						});
